...
def main():
    data_dir = "/Users/zhangxiaoyu/Desktop/SSM Time cell/round1/lambda_bar"
    ...
    fig1.savefig(os.path.join(data_dir, "Lambda_relative_change.png"), dpi=300, bbox_inches="tight")
    ...
    fig2.savefig(os.path.join(data_dir, "B_relative_change.png"), dpi=300, bbox_inches="tight")
    ...
    fig3.savefig(os.path.join(data_dir, "C_tilde_relative_change.png"), dpi=300, bbox_inches="tight")
